//WRITE A C PROGRAM TO CHECK THE STRENGTH OF THE
//PASSWORD
...
while(flag1!=0||flag2!=0||flag3!=0||flag4!=0||flag5!=0)
 ...
 count++;
 if(count==length)
 printf("\nYOUR PASSWORD SHOULD CONTAIN ATLEAST ONE SPECIAL
CHARACTER\n");
 else
 flag3=0;
 }
 ...
 ct++;
 if(ct==length)
 printf("YOUR PASSWORD SHOULD CONTAIN ATLEAST ONE UPPER CASE
CHARACTER\n");
 }
 else
 flag4=0;
